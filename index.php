          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header">
                <h1 class="animated lightSpeedIn">El fan del mate<small> </small></h1>
                <span class="label label-danger">Soporte Técnico de sus dueños</span>
